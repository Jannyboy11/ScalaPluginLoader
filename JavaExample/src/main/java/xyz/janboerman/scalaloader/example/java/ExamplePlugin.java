...
public class ExamplePlugin extends ScalaPlugin {
    ...
    public ExamplePlugin() {
        super(new ScalaPluginDescription("JavaExample", "0.13.2-SNAPSHOT").addHardDepend("ScalaExample"));
    }
    ...
    public void onEnable() {
        ...
        //ClassCastException! ScalaPluginClassLoader cannot be cast to PluginClassLoader! WHY IS BUKKIT TRYING CAST MY SCALACLASSLOADER TO A JAVA PLUGINCLASSLOADER?!
