...
@DelegateSerialization(value = Array(classOf[Just[_]], classOf[NoValue]), as = "Maybe")
...
//TODO use Scan.Type.SINGLETON_OBJECT in Scala 2.13.4
//TODO see https://github.com/scala/scala/pull/9279
@ConfigurationSerializable(scan = new Scan(Scan.Type.CASE_CLASS), as = "Nothing")
case class /*object*/ NoValue() extends Maybe[scala.Nothing] {
//    //generated by the classloader (2nd pass, as serialize())
//    def serialize(): java.util.Map[String, AnyRef] = {
//        val map = new java.util.HashMap[String, AnyRef]()
//        map.putAll($serialize())
