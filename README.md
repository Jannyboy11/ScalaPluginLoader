...
Note that while ScalaLoader can run on Java 8, it requires JDK-27 to compile.
...
libraryDependencies += "com.janboerman.scalaloader" % "ScalaLoader" % "0.18.18-SNAPSHOT" % "provided"
```
