 ...
 *                  which basically boils down to you can't use this from a JavaPlugin. Use Bukkit's Listener/EventHandler reflection api instead!
 *           </p>
 * <pre>
 *     <code>
 *         public class MyListener implements org.bukkit.event.Listener {
 *            {@literal @} org.bukkit.event.EventHandler
 *            public void onEvent(SomeScalaPluginEvent) {
 *                //use the event
 *            }
 *         }
 *     </code>
